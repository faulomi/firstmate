...
data/                personal fleet records; LOCAL, gitignored as a whole
  ...
  crew-dispatch/task-ledger.md  one machine-written row per ship or scout cleanup (model, effort, harness, outcome); appended by bin/fm-teardown.sh, never hand-edited
